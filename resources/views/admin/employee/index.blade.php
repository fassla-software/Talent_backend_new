    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <select name="role" id="role" class="form-control">
                ...
                <option value="envoy" {{ request('role') == 'envoy' ? 'selected' : '' }}>envoy</option>
        ...
        <div class="col-md-4">
            ...
            <input type="text" name="search" id="search" class="form-control" placeholder="Search by name or phone number" value="{{ request('search') }}">
        </div>
