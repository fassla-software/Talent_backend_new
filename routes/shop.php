...
Route::name('shop.')->group(function () {
    ...
    Route::middleware(['authShop', 'checkPermission'])->group(function () {
        ...
        Route::controller(ProductController::class)->group(function () {
            ...
            // Added bulk delete route for shop products
            Route::delete('/products/bulk-delete', 'bulkDestroy')->name('product.bulk.destroy');
        ...
        Route::controller(GiftController::class)->group(function () {
        	...
        	Route::get('/points', 'pointsPage')->name('points.index');
