...
class User extends Authenticatable
{
    ...
    protected static function boot()
    {
        ...
        Cache::forget('rootUser'); // Forget cache
        ...
        try {
            AdminPlumberNotification::create([
                ...
                'firebase_id' => null, // No Firebase notification needed for now
                'data' => json_encode(['user_id' => $user->id]),
                'read' => false,
            ]);
        } catch (\Exception $e) {
            Log::error("Failed to create admin notification for new user: " . $e->getMessage());
        }
    });
