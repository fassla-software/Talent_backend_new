...
class ProductRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'thumbnail' => "$thumbnail|image|mimes:png,jpg,jpeg,webp",
            'additionThumbnail' => "$addtionThumbnail|array",
            'additionThumbnail.*' => 'image|mimes:png,jpg,jpeg,webp',

            'previousThumbnail' => 'nullable|array',
            'previousThumbnail.*.id' => 'nullable|exists:media,id',
            'previousThumbnail.*.file' => 'nullable|file|mimes:png,jpg,jpeg,webp',
        ];
    }
